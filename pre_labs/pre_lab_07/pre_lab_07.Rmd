...
**Answer**
Nevada was the state with the largest percent change, with a change of 35.15%.
...
**Answer**
It looks like Howard County has the highest household income, with a median of $121,160.
...
**Answer**
It is not that significant since the margin of error between Calvert and Montgomery is so close together. It could mean that the two counties flip flop for second and third.

Is the difference between Howard and everyone else significant?
**Answer**
The difference between Howard and the other counties is significant because of how much higher it is. The MOE sets it a part and it will be the highest no matter which way it goes.
...
**Answer**
The first two counties listed in the tibbles median incomes fell from 2010-2020 when comparing their mininum and maximums. It doesn't look like they were outside of the MOE.
...
**Answer** 
Baltimore City was the only one included in the top 20 with an estimated median household income of less than 50k.
...
**Answer** 
I am interested in knowing more about the top 9 which all have median household incomes above $200,000. I am interested in knowing more about the counties these homes are in, what areas they are geographically closest too and the population demographics for these counties. I would also be interested in knowing about these number of family homes in these counties if available. When looking at the ACS data I know there was info on homes and it they were married couples and whatnot. 

```{r}
zips_acs_arranged <- md_zips_with_acs %>%

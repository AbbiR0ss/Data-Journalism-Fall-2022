...
**Answer** 
I think the code is adding a section that includes the percentage of votes that were received on election day.
...
**Answer**
This task rearranged the tibble so that it is sorted by the highest percentage of votes received on election day. 
...
**Answer**
I do think this tibble is more interesting. It's great when people show up to vote, but there is also an important story in the places that have less show. What type of voters are these and in what types of counties? Are they voting in different ways or not showing up?
...
**Answer**
One option is str_to_lower() which would turn the selected text lowercase. The other is  str_to_title() which would make the first letter of each word capitalized.
...
**Answer** 
The mutate statement is starting to make the data easier to handle by adding a group based on the amount contribued. So instead of looking at a tibble where the amounts are just listed out, we have an actual idea of how much people were donating. While it's not totally cleaned up yet, we can more know easily know if contributions were more often less than $100, between $100 and $500, etc. It's more tangible.
...
**Answer** 
In terms of dollar amounts, the less than $100 catergory is the largest with a total of $868,921.
...
**Answer** 
This makes looking at the data easier to understand and more manageable. We're now just working with the total number of votes instead of them plus columns for election day, provisional, absentee, etc.
...
**Answer:**
The tibble has the dates actaully characterized as dates. We know this because of the <date> title, as well as the formatting. They're not year/month/day as they should be.
...
**Answer**
All of the values included in the month column are from the first of the month. I assume that amount would be whatever was amount was spent for the month before. I would also assume there's some significance to there only being three dates from 2020 and 2021. They could be the most from those years but that seems unlikely. Those months could be the start/end of something important in the campaigns or could mark slow months for campaigning since this is expenditures.

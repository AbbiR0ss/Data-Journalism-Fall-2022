...
**Answer:**
It gives you the answer for number x number which equals 4.
...
**Answer**
54,247 observations and 24 variables. 
### Task 3: Glimpse data
...
**Answer**
Showing the number on contributions a day. 
### Task 7
**Task** Run the following codeblock:
...
**Answer**
The dates are no longer chronological and now the contribution amounts vary more day to day than they did before.
### Task 8
**Task** Run the following codeblock.
```{r}
maryland_winred_contributions %>%
...
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer**
I'm not sure if my code ran correctly, I'm getting two small boxes side by side as well as a list of earmarked names from the memo.
### Task 9
**Task** Run the following codeblock:
```{r}
maryland_winred_contributions %>%
...
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer**
I'm still a little confused on if it's running correctly. This result is similar to the last one in that it has the earmarked list again. There are no side by side boxes though. It has more politician names than political groups listed.
### Task 10
...
**Answer**
This block is laid out similarly, but it is all politician campaigns from other states (Nevada, Missouri, New Mexico, etc.) instead of groups like national committees.
### Task 11
...
**Answer**
This codeblock is looking at cities and their contribution numbers opposed to the contribution amounts from political groups and committees.This gives you a much more detailed look at what was going on in Maryland with contributions and where the most money was coming from location wise. I'm not sure if we need to do the median, mean, etc. separately or if I did that correctly.

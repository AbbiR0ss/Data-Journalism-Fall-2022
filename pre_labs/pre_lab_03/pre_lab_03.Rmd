...
**Answer**
There were 1,640 rows. I think this problem is because of the characters/numbers in the expected caolumn.
...
**Answer**:
There are 402,345 results that are NA, this could mean
```{r}

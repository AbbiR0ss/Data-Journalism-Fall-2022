...
**Answer** 
I think there is one <ul> tag with multiple <li> tags within it.
```{r}
...
**Answer** 
This code is taking the HTML list elements and turning it into text, I think.
...
**Answer**
This gave us a table of the different groups.
```{r}

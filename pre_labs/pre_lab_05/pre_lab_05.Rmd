...
**Answer**
Spelling and grammar errors are creating different versions of the same restaurant, like with Joe's Seafood, Prime Steak and Stone Crab.
...
**Answer**
Two examples of changes it made are with Joe's Seafood Prime Steak and Stone Crab which now has a comma after seafood, and with Le Diplomate, where it cut off the name being repeated again.
...
**Answer**
1.) Hilton Washington is now Washington Hilton
2.) Pizza, We The is now We The Pizza
3.) The first W. Millar and Co listed is now W. Millar and Co.
...
**Answer**
I'm not noticing any big differences between what the two have done.
...
***Answer***
```{r}
dc_food_open_refine_vers <- read_csv("data/dc_food_refine_clean.csv")
```

...
https://datawrapper.dwcdn.net/vhWT2/1/
...
This gives us a zoomed in look at Maryland and its counties instead of the original view of the whole U.S. and all of its counties
...
**Answer** Describe the changes from the previous map
This made the map easier to read and explains what you're looking at in a better way. Since we replaced the fips code with the county, we now know what counties we're looking at on the map. This also shortened the percentages to a much more readable number.
...
https://datawrapper.dwcdn.net/tD6kF/1/
